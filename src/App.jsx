...
function App() {
  ...
  const fetchUserData = async (username, userType) => {
    try {
      ...
      const dataUrl = "https://docs.google.com/spreadsheets/d/18y2Pcg_GW0pxw-oJ-nA3MJtj6NJ2ESGqbn5DErLpFpQ/gviz/tq?tqx=out:json&sheet=Data"
  ...
  const login = async (username, password) => {
    try {
      ...
      const loginUrl = "https://docs.google.com/spreadsheets/d/18y2Pcg_GW0pxw-oJ-nA3MJtj6NJ2ESGqbn5DErLpFpQ/gviz/tq?tqx=out:json&sheet=Login"
...
//     loginTime: new Date().toISOString()
//   }) // Set default user
//   const [userType, setUserType] = useState("admin") // Set default user type
//   const [userData, setUserData] = useState(null)
...
//   // Protected route component - now always allows access since we're auto-logged in
//   const ProtectedRoute = ({ children, adminOnly = false }) => {
//     // Since we're always authenticated, just return children
//     return children
//   }
...
//         <Router>
//           <div className="min-h-screen flex flex-col bg-white text-gray-900">
//             <MainNav logout={logout} userType={userType} username={currentUser?.username} />
//             <main className="flex-1">
//               <Routes>
//                 <Route
//                   path="/"
